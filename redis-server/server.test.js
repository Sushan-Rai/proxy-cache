...
test("should return correct TTL for a key and error cases", async () => {
  ...
  assert.strictEqual(
    errorResponse,
    "-ERR wrong number of arguments for the TTL command\r\n"
  );
});
...
test("should INCR a key and error cases", async () => {
  ...
  assert.strictEqual(
    response2,
    "-ERR wrong number of arguments for the INCR command\r\n"
  );
...
test("should DECR a key and error cases", async () => {
  ...
  assert.strictEqual(
    response2,
    "-ERR wrong number of arguments for the DECR command\r\n"
  );
...
test("should return error for LRANGE invalid key", async () => {
  ...
  assert.strictEqual(
    errorResponse1,
    "-ERR wrong number of arguments for the LRANGE command\r\n"
  );
...
test("should LPUSH for a key, error cases and LRANGE", async () => {
  ...
  assert.strictEqual(
    errorResponse1,
    "-ERR wrong number of arguments for the LPUSH command\r\n"
  );
...
test("should RPUSH for a key, error cases and LRANGE", async () => {
  ...
  assert.strictEqual(
    errorResponse1,
    "-ERR wrong number of arguments for the RPUSH command\r\n"
  );
...
test("should LPOP for a key, error cases and LRANGE", async () => {
  ...
  assert.strictEqual(
    errorResponse,
    "-ERR wrong number of arguments for the LPOP command\r\n"
  );
});
...
test("should RPOP for a key, error cases and LRANGE", async () => {
  ...
  assert.strictEqual(
    errorResponse,
    "-ERR wrong number of arguments for the RPOP command\r\n"
  );
});